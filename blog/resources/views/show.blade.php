        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="/theme/create" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                          <label for="title">Theme title</label>
                          <input type="text" class="form-control" id="title" name="title" placeholder="Enter theme title" value="{{ old('theme') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea id="description" name="description" class="form-control" rows="3" placeholder="Theme description...">{{ old('description') }}</textarea>
                        </div>
                        <div class="form-group">

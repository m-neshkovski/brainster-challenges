...
use \Market\Stall;
use \Market\ProductInKg;
use \Market\ProductInSack;

$orange = new ProductInKg ('Orange', 35);
$orange->setIn_stock(100.000);

$potato = new ProductInSack ('Potato', 240);
$potato->setIn_stock(10);

$nuts = new ProductInKg ('Nuts', 850);
$nuts->setIn_stock(25.000);

$kiwi = new ProductInSack ('Kiwi', 670);
$kiwi->setIn_stock(60);

$pepper = new ProductInSack ('Pepper', 330);
$pepper->setIn_stock(20);

$raspberry = new ProductInKg ('Raspberry', 555);

<?php 
    ...
    // readLineByLine('./credentials.txt');
    ...
    <div class="container">
        <div class="row row-100vh d-flex justify-content-center align-items-center">
            <div class="col-4 text-center">
                <h1 class="display-3 font-weight-bold pb-5">Sign up form</h1>
                <form action="signup.php" method="POST">
                    <div class="form-group">
                        <input id="email" name="email" type="text" class="form-control <?php if (if_POST()) {
                                                                                                if (fieldRequired('email', 'POST') && validateEmail($_POST['email']) && !emailExistsIn($_POST['email'], $credentials)) {
                                                                                                    echo 'is-valid';
                                                                                                } else {
                                                                                                    echo 'is-invalid';
                                                                                                } 
                    ...
                    <div class="form-group">
                        <input id="username" name="username" type="text" class="form-control <?php if (if_POST()) { 
                                                                                                if (fieldRequired('username', 'POST') && validateUsername($_POST['username']) && !usernameExistsIn($_POST['username'], $credentials)) {
                                                                                                    echo 'is-valid';
                                                                                                } else {
                                                                                                    echo 'is-invalid';
                                                                                                }
                    ...
                    <div class="form-group">
                        <input id="password" name="password" type="password" class="form-control  <?php if (if_POST()) {
                                                                                                    if (fieldRequired('password', 'POST') && validatePassword($_POST['password']) && stringMatch($_POST['password'], $_POST['repeatPass'])) {
                                                                                                        echo 'is-valid';
                                                                                                    } else {
                                                                                                        echo 'is-invalid';
                                                                                                    } 
                        ...
                        <?php if (fieldRequired('password', 'POST')) {
                                if (validatePassword($_POST['password'])) {
                                    if (stringMatch($_POST['password'], $_POST['repeatPass'])) {
                                        echo '<div class="valid-feedback text-left">Strong password.</div>';
                                    } else {
                                        echo '<div class="invalid-feedback text-left">Strong password. Passwords do not match.</div>';
                                    }
                                } else {
                                    echo '<div class="invalid-feedback text-left">Weak password! Must be at least 8 characters, minimum one capitall letter and minimum one special sign!!!</div>';
                                }
                        } else {
                    ...
                    <div class="form-group">
                        <input id="repeatPass" name="repeatPass" type="password" class="form-control <?php if (if_POST()) {
                                                                                                        if (fieldRequired('repeatPass', 'POST') && validatePassword($_POST['password']) && stringMatch($_POST['password'], $_POST['repeatPass'])) {
                                                                                                                echo 'is-valid';
                                                                                                            } else {
                                                                                                                echo 'is-invalid';
                                                                                                            } 
                                                                                                        }?>" placeholder="Repeat password (required)" value="<?php if (fieldRequired('repeatPass', 'POST')) {
                                                                                                                                                                            echo $_POST['repeatPass'];
                                                                                                                                                                        } ?>">
                    <?php
                        if (fieldRequired('repeatPass', 'POST') && validatePassword($_POST['password'])) {
                            if (stringMatch($_POST['password'], $_POST['repeatPass'])) {
                                echo '<div class="valid-feedback text-left">Passwords match.</div>';
                                if (if_POST()) {
                                    if((fieldRequired('email', 'POST') && validateEmail($_POST['email']) && !emailExistsIn($_POST['email'], $credentials))
                                ...
                                echo '<div class="invalid-feedback text-left">Passwords do not match!!!</div>';
                            }
                        } else {
                            echo '<div id="email" class="invalid-feedback text-left">Repeat password is required!!!</div>';
                        }
                    ?>
                    </div>
